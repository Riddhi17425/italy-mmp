...
{!! $data['products']->faq_schema !!}
<!-- banner -->

@if ($data['products']->producturl == 'cartucce-filtranti-soffiate-a-fusione')
  ...
  <div class="video_banner">
    <video autoplay muted loop playsinline width="100%" class="mob_desk">
      <source src="{{ asset('public/front/images/Pleated_Filter_Bags_Verticle.mp4') }}" type="video/mp4"> Your browser does not support the video tag.
    </video>
    <video autoplay muted loop playsinline width="100%" class="desk_vid">
      <source src="{{ asset('public/front/images/cta_vid_2.mp4') }}" type="video/mp4"> Your browser does not support the video tag.
    </video>
    <!--<div class="col-lg-6">-->
      <div class="col-lg-6 col-md-6 contact-head product-contact-head">
        <h1 class="mb-3 mb-xl-4">Cartucce filtranti soffiate a fusione</h1>
        <div class="set-content">
          <p>Filtri PP soffiati certificati NSF per un’elevata efficienza, adattamento personalizzato e una filtrazione affidabile.</p>
        </div>
        <div class="theme-btn justify-content-start ">
          <button type="button" class="btn-add" data-bs-toggle="modal" data-bs-target="#inquiryModal">
            <span>
              <i class="fa fa-angle-right" aria-hidden="true"></i>
            </span>
            <p style="color:#17367f;">Richiedi Ora</p>
          </button>
        </div>
      </div>
      <!--</div>-->
...
<!-- filter-inner -->
<section class="filter-inner pb-4">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="m-add">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="{{ route('productinquiry') }}" id="productinquiry">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-group">
                                                <input type="text" placeholder="" id="product_name" required name="product_name" 
                                                    value="{{ $data['products']->product_name }}" readonly />
                                        ...
                                        <div class="mb-3">
                                            <div class="form-group">
                                                <textarea name="message" id="message" required rows="4" class="w-100" placeholder=""></textarea>
        ...
        <div class="row">
            <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                <div class="manufacturing">
                    <?php if ($data['products']->product_image) {
                        if (strpos($data['products']->product_image, ',') !== false) {
                            $image = explode(',', $data['products']->product_image);
                        } else {
                            $image[0] = $data['products']->product_image;
                        }
                    } ?>
                    @foreach($image as $k=>$v)
                    <div>
                        <img src="{{ asset('public/Product_Images/'.$v) }}" alt="{{$data['products']->product_name}}" class="img-fluid">
                    </div>
                    @endforeach
                </div>
                  @if ($data['products']->producturl == 'sacchetti-filtranti-pleat' || $data['products']->producturl == 'cartucce-pleat') 
                    <p class="mt-2">
                        Si prega di informarsi su
...
@endif
 ...
 @if ($data['products']->producturl == 'sacchetti-filtranti-pleat') 
    <video autoplay muted loop playsinline width="100%">
...
<section>
  <div class="container">
    @if ($data['products']->producturl == 'high-flow-pleated-filter') 
        <div class="row">
            <div class="col-md-7">
            <h3 class="dref-text">Applicazione</h3>
               <ul class="dref-spinning">
                  <li>Desalinizzazione dell’acqua di mare</li>
                  <li>Olio e prodotti chimici</li>
                  <li>Alimenti e bevande</li>
                  <li>Combustibili bianchi</li>
                  <li>Acqua di processo</li>
                  <li>Ammina, glicole</li>
                  <li>Trattamento delle acque nelle centrali elettriche</li>
                  <li>Nafta, condensa di idrocarburi</li>
                  <li>Prefiltrazione di protezione RO</li>
                  <li>Trattamento delle acque negli impianti siderurgici</li>
                </ul>
            </div>
             <div class="col-md-5">
    ...
    <div class="container">
        ...
        <div class="tab-content details-tabs-content" id="myTabContent">
            <div class="tab-pane details-content-pane fade active show" id="home" role="tabpanel"
                ...
                <p>Il filato in polipropilene (Filato PP) è uno dei primi filati sintetici versatili ad alte prestazioni ampiamente utilizzato in diversi settori grazie all’eccellente resistenza, durabilità e leggerezza. Essendo prodotto in polipropilene, un polimero termoplastico, questo filato risulta superiore in termini di resistenza chimica, all’umidità e all’abrasione, rendendolo ideale per applicazioni impegnative.</p>
            </div>
            <div class="tab-pane details-content-pane fade" id="profile" role="tabpanel"
                aria-labelledby="profile-tab">
                <p class="cursor-hover">Il filato in polipropilene (Filato PP) di <b>mmp</b> è prodotto per garantire soluzioni affidabili e ad alte prestazioni in una vasta gamma di settori, offrendo una qualità senza pari su cui puoi contare. Ecco cosa rende unico il nostro filato:</p>
                <ul style="list-style: disc; padding-left:23px">
                    <li><strong>Costruito per durare:</strong> il nostro filato è altamente resistente e può sopportare utilizzi intensivi in applicazioni impegnative.</li>
                    <li><strong>Forte e affidabile:</strong> con un’eccezionale resistenza alla trazione, è perfetto per esigenze industriali e commerciali dove la robustezza è fondamentale.</li>
                    <li><strong>Leggero come una piuma: </strong> nonostante l’elevata resistenza, il PP Yarn <b>mmp</b> è leggero, facile da maneggiare e migliora l’efficienza.</li>
                    <li><strong>Resistente in condizioni difficili:</strong> resistente ad acidi, alcali e alla maggior parte dei prodotti chimici, mantiene le prestazioni anche in ambienti complessi.</li>
                    <li><strong>Pronto al sole: </strong>offriamo opzioni personalizzabili in termini di colori, dimensioni e specifiche per soddisfare al meglio le tue esigenze.</li>
                    <li><strong>Su misura per te: </strong>offriamo opzioni personalizzabili in termini di colori, dimensioni e specifiche per soddisfare al meglio le tue esigenze.</li>
                    <li><strong>Scelta eco-consapevole: </strong> la sostenibilità è importante per noi. Ecco perché il PP Yarn <b>mmp</b> è riciclabile e progettato rispettando l’ambiente.</li>
                    <li><strong>Eccellenza accessibile: </strong> il meglio di entrambi i mondi – qualità premium a un prezzo competitivo.</li>
                    <li><strong>Nessuna preoccupazione per l’umidità: </strong>  la sua natura idrorepellente assicura prestazioni costanti anche in condizioni umide o bagnate.</li>
                </ul>
            </div>
...
<section class="products-feature-tabs pb-0">
    <div class="container">
        ...
        <ul class="nav nav-tabs details-tabs" id="myTab" role="tablist">
            ...
            @if (!empty($data['products']->tab_features))
                <li class="nav-item" role="presentation">
                    <button class="nav-link @if (empty($data['products']->tab_app)) active @endif" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false"><h3>Caratteristiche</h3></button>
                </li>
            @endif
            @if (!empty($data['products']->tab_app))
                <li class="nav-item" role="presentation">
                    <button class="nav-link @if (empty($data['products']->tab_app) && empty($data['products']->tab_features)) active @endif" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false"><h3>Applicazioni</h3></button>
                </li>
            @endif
        </ul>
        <div class="tab-content details-tabs-content" id="myTabContent">
...
<section class="Product-detail-faq">
    ...
    @else
       Domande Frequenti Sulle {{ $data['products']->product_name }}
    @endif
        </h3>
    ...
    <div class="col-xl-3 col-md-6 col-sm-12">
        <div class="feature-box">
            ...
            <div class="feature-text">
                ...
                multiple sizes to meet diverse filtration needs.</p>
            </div>
        </div>
    </div>
    <div class="col-xl-3 col-md-6 col-sm-12">
 ...
 <section>
     <div class="container">
         <div class="row m-add">
            ...
            <div class="col-md-5 mb-4">
                <div class="product-detail">
                    <div><img src="{{ asset('public/Product_Images/WoundFilter_product.jpg') }}" alt="Wound Filter" class="img-fluid" ></div>
                   </div>
            </div>
            <div class="col-md-7 mb-4">
               <h2 class="dref-text mb-3">Caratteristiche e Vantaggi Principali</h2>
               <ul class="dref-spinning" style="padding-left:2rem!important;">
                <li><strong>Controllo di precisione:</strong> dotata di drive e motore a frequenza variabile AC per una maggiore precisione e controllo nel processo di avvolgimento, con velocità regolabili.</li>
                <li><strong>Opzioni di alimentazione versatili:</strong> funziona con alimentazione standard o monofase (AC 220V/50HZ).</li>
                <li><strong>Funzionamento a doppio mandrino:</strong>  dispone di due mandrini per produrre contemporaneamente due cartucce filtro avvolte, della stessa o di diversa lunghezza.</li>
                <li><strong>Automazione avanzata:</strong> sensori di arresto automatico e ingranaggi di temporizzazione manuale garantiscono schemi di avvolgimento precisi.
                </li>
                <li><strong>Adattabilità ai materiali:</strong> Ssupporta nuclei di avvolgimento in polipropilene, acciaio inox o acciaio stagnato.</li>
              </ul>
               <p class="dref-text pt-3">Scopri la potenza della Macchina Avvolgitrice di Cartucce Filtro Inlinea</p>
               <div class="theme-btn justify-content-start">
                    <a href="https://mmpfilter.com/public/front/images/Inline-Filter-Cartridge-Winding-Machine-Brochure.pdf" target="_black" class="nav-link btn-add dawnload-bnt"><span><i class="fa fa-angle-right" aria-hidden="true"></i></span>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 pb-3">
            ...
            <h3 class="dref-text">Alta efficienza</h3>
            <p class="short_dis">Massimizza la produzione con tempi di fermo minimi.</p>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 pb-3">
            ...
            <h3 class="dref-text">Personalizzazione </h3>
            <p class="short_dis">Impostazioni flessibili per soddisfare requisiti specifici in termini di dimensioni del filtro.</p>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 pb-3">
            ...
            <h3 class="dref-text">Precisione</h3>
            <p class="short_dis">Gli ingranaggi di sincronizzazione garantiscono schemi di avvolgimento precisi e costanti.</p>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 pb-3">
            <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h3 class="dref-text">Affidabilità </h3>
            <p class="short_dis">La struttura robusta e il funzionamento pressoché esente da manutenzione garantiscono un'affidabilità a lungo termine.</p>
        </div>
    </div>
</div>
            <!-- <div class="col-md-7">-->
            ...
            <div class="col-md-7 machine-table">
                            <h3 class="text-start inner-head mb-4">SPECIFICHE TECNICHE</h3>
                <table class="table table-striped ">
            <tbody>
                <tr>
                  <th scope="row">Nome della macchina</th>
                  <td>Dettagli</td>
                  
                </tr>
                <tr>
                  <th scope="row">Motore e trasmissione</th>
                  <td>Motore e drive a frequenza variabile AC</td>
                  
                </tr>
                <tr>
                  <th scope="row">Alimentazione</th>
                  <td>220V/50HZ, monofase</td>
                  
                </tr>
                <tr>
                  <th scope="row">Materiale del nucleo di avvolgimento</th>
                  <td>Polipropilene, acciaio inox o acciaio stagnato</td>
                  
                </tr>
                <tr>
                  <th scope="row">Diametro tubo di avvolgimento</th>
                  <td>28mm</td>
                  
                </tr>
                <tr>
                  <th scope="row">Lunghezze di avvolgimento disponibili</th>
                  <td>222, 235, 250, 254, 500, 508, 750, 762, 1000, 1016, 1270, 1778 mm</td>
                  
                </tr>
                <tr>
                  <th scope="row">Sensore di arresto automatico</th>
                  <td>Si attiva al raggiungimento del diametro cartuccia desiderato</td>
                  
                </tr>
                <tr>
                  <th scope="row">Diametro esterno di avvolgimento (OD)</th>
                  <td >45 mm 200 mm</td>
                  
                </tr>
                <tr>
                  <th scope="row">Schema e precisione</th>
                  <td>Ottenuti tramite ingranaggi di temporizzazione</td>
                </tr>
                <tr>
                  <th scope="row">Manutenzione</th>
                  <td>Progettata per richiedere manutenzione minima</td>
                </tr>
              </tbody>
            </table>
    </div>
...
<script>
   $('#productinquirysubmit').on('click', function(event) {
    ...
    if (name === '' || containsSpamContent(name)) {
        $('#name').siblings('.error-message').text('Per favore inserisci un Nome valido.');
        isValid = false;
    }
    ...
    if (message === '' || containsSpamContent(message)) {
        $('#message').siblings('.error-message').text('Per favore inserisci un Messaggio valido.');
        isValid = false;
    }
    ...
    if (city === '' || containsSpamContent(city)) {
        $('#city').siblings('.error-message').text('Per favore inserisci una Città valida.');
        isValid = false;
    }
    ...
    if (recaptchaResponse.length === 0) {
        $('#captcha-error').text('Per favore completa il CAPTCHA.');
        isValid = false;
    } else {
        $('#captcha-error').text('');
    }
...
// Pulisce messaggi errore quando si scrive
