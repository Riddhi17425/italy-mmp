...
<section class="contact-banner position-relative">
  <div class="container-fluid p-0">
    <img src="{{ asset('public/front/images/contact-banner-bg.jpg') }}" alt="Contatta Banner" class="img-fluid product-page-header" />
    <div class="contact-head">
      <h1>Carriera</h1>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="{{ url('/')}}">Home</a></li>
          <li class="breadcrumb-item active" aria-current="page">carriera</li>
        </ol>
      </nav>
    </div>
  </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 mb-2">
                <h2>Sblocca il tuo Potenziale e Realizza i tuoi Obiettivi di Carriera con Noi</h2>
                <p>In <b>mmp</b> Filtration, ci impegniamo a offrirti una carriera appagante che ti sfidi a crescere professionalmente e a fare la differenza nel mondo. Unisciti a noi nello sviluppo di soluzioni solari per affrontare le sfide energetiche globali, all’interno di un ambiente di squadra solidale che favorisce crescita e ispirazione. Diamo priorità al tuo benessere, al successo della nostra azienda e alla salute del pianeta, offrendoti un’esperienza indimenticabile in cui potrai davvero prosperare. Esplora oggi le nostre opportunità di carriera e scopri il ruolo perfetto per te. Unisciti a noi e vivi in prima persona la differenza.</p>
            </div>
            <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <label for="career_name">Nome</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <label for="career_phone">numero di contatto</label>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <label for="career_message">Messaggio</label>
                                    <div id="career-message-error" class="text-danger"></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <p>Carica il tuo CV (PDF/DOC/DOCX max 25MB)</p>
                            ...
                            <div class="col-lg-12">
                                <button class="submit-button" id="career_submit_btn" type="submit">Invia</button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    if (careerForm) {
        careerForm.addEventListener("submit", function (event) {
            ...
            if (!file.files.length) {
                fileError.innerText = "È obbligatorio caricare il curriculum.";
                isValid = false;
            } else {
                let fileSize = file.files[0].size / 1024 / 1024; // in MB
                let fileExt = file.files[0].name.split('.').pop().toLowerCase();
                if (!['pdf', 'doc', 'docx'].includes(fileExt)) {
                    fileError.innerText = "Sono consentiti solo file PDF, DOC o DOCX.";
                    isValid = false;
                } else if (fileSize > 25) {
                    fileError.innerText = "Il file deve essere inferiore a 25 MB.";
                    isValid = false;
                } else {
                    fileError.innerText = "";
                }
            ...
            if (!captchaResponse || captchaResponse.length === 0) {
                captchaError.innerText = "Si prega di compilare il CAPTCHA.";
                isValid = false;
            } else {
