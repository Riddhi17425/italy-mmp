@include('layouts.frontheader')
    ...
    <div class="certification-inner">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p><b>mmp</b> Filtration Pvt Ltd is NSF Certified for its MELT BLOWN CARTRIDGES - OCEANIC<sup>®</sup> & LAGOON<sup>®</sup> - and conforms to the requirements of NSF/ANSI/CAN-61 & 372 for drinking water systems components.</p>
                </div>
            </div>
