...
<section class="contact-banner position-relative">
  <div class="container-fluid p-0">
    <img src="{{ asset('public/front/images/event-banner-bg.jpg') }}" alt="Eventi" class="img-fluid product-page-header" />
    <div class="contact-head">
      <h1>I Nostri Ultimi Eventi</h1>
...
<section class="event-inner">
  <div class="container">
        ...
        <div>
          ...
          <ul class="p-0 mt-3">
            <li class="d-flex align-items-start mb-2">
              <span><img src="{{ asset('public/front/images/contact-map.png') }}" alt="Contatto Mappa" class="img-fluid me-2" /></span>
    ...
    @foreach($event as $key => $val)
    <div class="modal fade overflow-auto" id="exampleModal-{{ $key }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-{{ $key }}" aria-hidden="true">
